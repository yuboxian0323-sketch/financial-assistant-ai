...
export function SettingsScreen() {
  ...
  return <Screen title="Settings" subtitle="Foundation preferences and local system information.">
    ...
    <Divider />
    <SectionHeader title="AI Support" subtitle="Gemini is connected through a protected server route." />
    <Button label="Open AI Support" icon="sparkles-outline" onPress={() => router.push('/ai-support')} />
    <Divider />
    ...
    <BottomSheet visible={developer} title="Developer Info" onClose={() => setDeveloper(false)}><AppText tone="secondary">SQLite knowledge base · Finnhub market data · Gemini 3.7 Flash AI Support · No brokerage integration</AppText><Button label="Close" variant="ghost" onPress={() => setDeveloper(false)} /></BottomSheet>
  </Screen>;
}
